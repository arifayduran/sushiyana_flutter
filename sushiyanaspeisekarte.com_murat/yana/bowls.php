...
<body class="artikelliste">
    ...
    <div class="content">
        ...
        $sql = "SELECT * FROM `bowls` WHERE `vegetarisch` = 1 ORDER BY `bowls`.`artikelnummer` ASC";
        ...
        $sql = "SELECT * FROM `bowls` WHERE `vegetarisch` = 0 ORDER BY `bowls`.`artikelnummer` ASC";
        $result = $conn->query($sql);
