...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Yellow Curry mit:</h1>
        <h2>Alle Gerichte werden mit Kokosmilch-Sahne und frischem Gemüse zubereitet und mit Jasmin-Reis serviert.:</h2>
        <?php
        ...
        $sql = "SELECT * FROM yellowcurry";
        // SQL-Abfrage zum Abrufen der Menüs
        $sql = "SELECT * FROM `yellowcurry` ORDER BY `yellowcurry`.`artikelnummer` ASC;";
