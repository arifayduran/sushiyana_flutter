...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Gebratene Nudeln mit:</h1>
        <h2>Alle Gerichte werden mit Ei, Karotten, Sojasprossen, Frühlingszwiebeln und Röstzwiebeln zubereitet.</h2>
        <?php
        ...
        $sql = "SELECT * FROM `nudeln` ORDER BY `nudeln`.`artikelnummer` ASC;";
