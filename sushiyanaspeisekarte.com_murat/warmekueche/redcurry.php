...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Redcurry mit:</h1>
        <h2>Alle Gerichte werden mit mit Kokosmilch, Sahne, frischem Gemüse und Thai-Basilikum zubereitet und mit Jasmin-Reis serviert.</h2>
        <?php
        ...
        $sql = "SELECT * FROM `redcurry` ORDER BY `redcurry`.`artikelnummer` ASC;";
