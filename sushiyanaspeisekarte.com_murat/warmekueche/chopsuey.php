...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Chop Suey mit:</h1>
        <h2>Alle Gerichte werden mit frischem Gemüse und Sojasprossen zubereitet und mit Jasmin-Reis serviert.</h2>
        <?php
        ...
        $sql = "SELECT * FROM `chopsuey` ORDER BY `chopsuey`.`artikelnummer` ASC;";
