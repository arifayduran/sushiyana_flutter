...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Gebratener Reis mit:</h1>
        <h2>Alle Gerichte werden mit Ei, frischem Gemüse, Sojabohnen und Röstzwiebeln zubereitet.</h2>
        <?php
        ...
        $sql = "SELECT * FROM `reis` ORDER BY `reis`.`artikelnummer` ASC;";
