...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Gebratenes Gemüse mit:</h1>
        <h2>Alle Gerichte werden mit Zitronengras, Paprika, Peperoni, Zwiebeln und sehr scharfer Kurkuma-Sauce zubereitet und mit Jasmin Reis serviert.:</h2>
        <?php
        ...
        $sql = "SELECT * FROM `gemuese` ORDER BY `gemuese`.`artikelnummer` ASC;";
