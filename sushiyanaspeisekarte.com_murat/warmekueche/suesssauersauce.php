...
<body class="artikelliste">
    ...
    <div class="content">
        <h1>Süss-Sauer Sauce mit:</h1>
        <h2>Alle Gerichte werden mit Ananas, Tomaten, Paprika und Karotten zubereitet und mit Jasmin-Reis serviert.</h2>
        <?php
        ...
        $sql = "SELECT * FROM suesssauersauce";
        // SQL-Abfrage zum Abrufen der Menüs
        $sql = "SELECT * FROM `suesssauersauce` ORDER BY `suesssauersauce`.`artikelnummer` ASC;";
